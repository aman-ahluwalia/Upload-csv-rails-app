...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { date: @name.date, description: @name.description, number: @name.number } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { date: @name.date, description: @name.description, number: @name.number } }
